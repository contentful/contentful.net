...
namespace Contentful.Core
{
    ...
    public interface IContentfulManagementClient
    {
        ...
        Task<ContentfulCollection<Webhook>> GetWebhooksCollection(string spaceId = null, string queryString = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="publiclyVisible">Whether the tag should be publicly visible in the delivery API.</param>
        /// <param name="cancellationToken">The optional cancellation token to cancel the operation.</param>
        ...
        /// <exception cref="ContentfulException">There was an error when communicating with the Contentful API.</exception>
        Task<ContentTag> CreateContentTag(string name, string id, bool publiclyVisible, string spaceId = null, CancellationToken cancellationToken = default);
